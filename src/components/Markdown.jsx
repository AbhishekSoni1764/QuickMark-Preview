    ...
    return (
        <div className="w-[-webkit-fill-available] lg:w-1/2 h-fit lg:h-screen border-2 border-grey-200 m-5 flex flex-col rounded-md bg-grey-300">
            <div className="w-full h-8 lg:h-10 border-2 border-grey-200 flex items-center">
                <Button value="**text-here**" handleInsertText={handleInsertText} imgUrl={'https://img.icons8.com/ios-filled/50/bold.png'} />
                <Button value='*text-here*' handleInsertText={handleInsertText} imgUrl={'https://img.icons8.com/ios-filled/50/italic.png'} />
                <Button value='<u>text-here</u>' handleInsertText={handleInsertText} imgUrl={'https://img.icons8.com/ios-filled/50/underline.png'} />
