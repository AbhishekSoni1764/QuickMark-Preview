...
export default function Markdown({ markdown, setMarkdown }) {
    ...
    return (
        <div className="w-[-webkit-fill-available] lg:w-1/2 h-fit lg:h-screen border-2 border-black m-5 flex flex-col">
            ...
            <textarea
                className="w-[-webkit-fill-available] outline-none h-fit lg:h-screen p-5"
                ref={textAreaRef}
                value={markdown}
